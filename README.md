...
```
sudo wget https://raw.githubusercontent.com/prince-terabits/Odoo-Installation/18.0/odoo_install.sh
```
...
```OE_VERSION``` is the Odoo version to install, for example ```18.0``` for Odoo V16.<br/>
...
There are known issues on DigitalOcean for example where the installation crashes on 1GB RAM machines. See https://github.com/prince-terabits/Odoo-Installation/issues/243
